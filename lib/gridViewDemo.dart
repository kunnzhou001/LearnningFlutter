...
class _GridPhotoViewerState extends State<GridPhotoViewer>
  ...
  void initState() {
    ...
    super.initState();
    _amController = new AnimationController(vsync: this)
  ...
  Offset _clampOffet(Offset offset) {
  ...
  void _handleOnScaleUpdate(ScaleUpdateDetails details) {
    setState(() {
      ...
      _offset = _clampOffet(details.focalPoint - _normalizedOffset * _scale);
    });
  }
  ...
  void _handleOnScaleEnd(ScaleEndDetails details) {
    ...
    _flingAnimation = new Tween<Offset>(
            begin: _offset, end: _clampOffet(_offset + direction * distance))
        .animate(_amController);
    _amController
      ..value = 0.0
